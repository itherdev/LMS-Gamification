	...
	<div class="container">
		<div class="row">
		  ...
		  <div class="col-md-6" style="margin-top: 15px">
		  	...
		  	<script type="text/javascript">
		  		$(document).ready(function(){
		  			...
		  			$("#btn_simpan_chal").click(function(){
		  				alert("Mohon maaf, fitur Update belum siap."); return;
		  				if($("#kalimat_chal").val()=="") {$("#pesan_error").text("Kalimat challenge masih kosong.");return;}
		  			...
		  			$(".link_chal").click(function(){
		  				...
		  				$(".trsub_chal").hide(); 
		  				switch(tid){
		  					case "link_chal__persyaratan": $(".tr_persyaratan").show(); break;
		  					case "link_chal__bobot": $(".tr_bobot").show(); break;
		  					case "link_chal__beatenby": $(".tr_beatenby").show(); break;
		  					case "link_chal__howto": $(".tr_howto").show(); break;
		  				}
		  			})
		  	...
		  	<style type="text/css">.trsub_chal{display: none}</style>
		  	<span>Challenge Detail:</span>
		  	<hr>
		  	<h3><?=$chal_name ?></h3>
		  	<p><?=$chal_desc ?></p>

		  	<style type="text/css">#tbchal td{padding: 3px 10px}</style>
		  	...
		  	<style type="text/css">#tbchal_bobot td{padding: 3px 10px}</style>
		  	...
		  	<style type="text/css">
		  		#tbchal_beatenby td{padding: 3px 10px}
		  		#tbchal_beatenby li, #tbchal_beatenby ul{ padding-left: 15px}
		  		#td_tbchal_beatenby {font-size: 10pt}
		  	</style>
		  	...
		  	<style type="text/css">
		  		#tbchal_beat td{padding: 3px 10px}
		  		#tbchal_beat li, #tbchal_beat ul{ padding-left: 15px}
		  		#td_tbchal_beat {font-size: 10pt}
		  	</style>
