		...
		<div class="alert alert-light">
			...
			<div class="alert alert-primary alert-has-icon">
				...
				<div class="alert-body">
					...
					<p></p>
					<p></p>
					<p>This repeat will take place on <strong>April 28, 2021 </strong> </p>
					<button class="badge badge-primary" id="uts"></button>
				</div>
			</div>
...
<script>
	...
	var countDownDate = new Date("April 28, 2021 15:37:25").getTime();
	...
	var x = setInterval(function() {
		...
		document.getElementById("uts").innerHTML = days + "d " + hours + "h " +
			minutes + "m " + seconds + "s ";

		// If the count down is finished, write some text
		if (distance < 0) {
			clearInterval(x);
			document.getElementById("uts").innerHTML = "EXPIRED";
		}
	}, 1000);
</script>