		...
		<div class="card px-5 py-5 ">
			...
			<div class="row">
				<div class="col-lg-6">
					...
					<table class="table table-bordered table-hover" style="margin-bottom: 40px; background-color: #fff; ">
						<thead bgcolor="#0046b7">
							<th style="text-align: center" colspan=2 height="80px">
								<a href="?p=pl_ldb" style="color: yellow;"> Your Rank :</a>
								<span style="font-size: 28pt;color: #fff"><?= $player_rank ?><sup><?= $player_rank_cap ?></sup></span> of <?= $jumlah_player ?> player
							</th>
						</thead>
						<tr>
						...
						<tr>
							<td class="tddas" colspan="2">
								<a href="#" id="link_qplay__player_questions_add" class="link_header btn btn-primary btn-block">Rise Up My Rank !!</a>
				...
				<div class="col-lg-6">
					...
					<table class="table table-bordered table-hover" bgcolor="white">
						<thead>
							<th colspan="3" bgcolor="#5f939a" height="80px">
								<center>
									<h4>The Best of <b>
											<font color="#fff"><?= $nama_room ?></font>
										</b></h4>
								</center>
							</th>
						</thead>
