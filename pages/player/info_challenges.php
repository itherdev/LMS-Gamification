...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#chal_filter_by_toggle").click(function() {
			$(this).hide();
			$("#chal_tabel_filter").show();
		})

		$("#chal_tabel_filter_toggle").click(function() {
			$("#chal_tabel_filter").hide();
			$("#chal_filter_by_toggle").show();
		})
		...
		$(".btn_nav").click(function() {
			...
			switch (id) {
				...
				case "last":
					...
					break;
				case "next":
					if (current_page < last_page) current_page++;
					break;
				case "prev":
		...
		$(".link_header").click(function() {
			...
			switch (tid) {
				case "link_list_tracer":
					$("#chal_div_list_chal").show();
					break;
				default:
					var rid = tid.split("__");
					var id = rid[1];
					switch (id) {
						case "2018":
							$("#chal_div_infografik_2018").show();
							break;
						case "2019":
							$("#chal_div_infografik_2019").show();
							break;
						case "2020":
							$("#chal_div_infografik_2020").show();
							break;
						case "2021":
							$("#chal_div_infografik_2021").show();
							break;
						case "2022":
							$("#chal_div_infografik_2022").show();
							break;
						case "2023":
							$("#chal_div_infografik_2023").show();
							break;
					}
			}
		})
