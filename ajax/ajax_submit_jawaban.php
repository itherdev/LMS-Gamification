...
# =====================================================
# ROOM ACTIVE POINT
$new_room_active_point = $room_active_point + 2;


# =====================================================
# SOAL EARNED POINT
$new_earned_point = $earned_point + $point_creator;
...
$new_my_point = $my_point + $player_point;
...
if($debug_mode){$q = mysqli_query($cn,$s) or die("Error #ajax submit jawaban::update #1; SQL: $s");}
...
if($debug_mode){$q = mysqli_query($cn,$s) or die("Error #ajax submit jawaban::update #3; SQL: $s");}
...
if($debug_mode){$q = mysqli_query($cn,$s) or die("Error #ajax submit jawaban::update #4; SQL: $s");}
else{$q = mysqli_query($cn,$s) or die("Error #ajax submit jawaban::update #4");}
...
\n -------
\n soal earned_point: $earned_point
\n soal new_earned_point: $new_earned_point
\n -------
\n room_active_point: $room_active_point
